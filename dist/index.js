...
const { WebClient } = __nccwpck_require__(7985);
...
if (!module.main) {
  const app = __nccwpck_require__(8245);
  let options = {
    sourceChannel: '',
    targetChannel: ''
  };
...
const is_stream_1 = __importDefault(__nccwpck_require__(192));
const p_queue_1 = __importDefault(__nccwpck_require__(9075)); // tslint:disable-line:import-name
const p_retry_1 = __importStar(__nccwpck_require__(5282));
const axios_1 = __importDefault(__nccwpck_require__(8228));
const form_data_1 = __importDefault(__nccwpck_require__(6449)); // tslint:disable-line:import-name
const methods_1 = __nccwpck_require__(2844);
const instrument_1 = __nccwpck_require__(2261);
const errors_1 = __nccwpck_require__(4272);
const logger_1 = __nccwpck_require__(7299);
const retry_policies_1 = __importDefault(__nccwpck_require__(1774));
const helpers_1 = __nccwpck_require__(2038);
/**
...
var WebClient_1 = __nccwpck_require__(6136);
...
const logger_1 = __nccwpck_require__(1143);
var logger_2 = __nccwpck_require__(1143);
...
const WebClient_1 = __nccwpck_require__(6136);
const eventemitter3_1 = __nccwpck_require__(1754);
...
__exportStar(__nccwpck_require__(3175), exports);
...
module.exports =
{
  parallel      : __nccwpck_require__(7789),
  serial        : __nccwpck_require__(8356),
  serialOrdered : __nccwpck_require__(4113)
};
...
var defer = __nccwpck_require__(4733);
...
var async = __nccwpck_require__(5906)
  , abort = __nccwpck_require__(2774)
  ;
...
var abort = __nccwpck_require__(2774)
  , async = __nccwpck_require__(5906)
  ;
...
var iterate    = __nccwpck_require__(3991)
  , initState  = __nccwpck_require__(6151)
  , terminator = __nccwpck_require__(2778)
  ;
...
var serialOrdered = __nccwpck_require__(4113);
...
var DelayedStream = __nccwpck_require__(3954);
...
var CombinedStream = __nccwpck_require__(5321);
var util = __nccwpck_require__(1669);
...
var mime = __nccwpck_require__(574);
var asynckit = __nccwpck_require__(133);
var populate = __nccwpck_require__(5136);
...
var db = __nccwpck_require__(4368)
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const EventEmitter = __nccwpck_require__(2160);
const p_timeout_1 = __nccwpck_require__(468);
const priority_queue_1 = __nccwpck_require__(6795);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const lower_bound_1 = __nccwpck_require__(9525);
class PriorityQueue {
    constructor() {
        this._queue = [];
    }
...
const retry = __nccwpck_require__(4325);
...
const pFinally = __nccwpck_require__(7023);
...
module.exports = __nccwpck_require__(9593);
...
var RetryOperation = __nccwpck_require__(8386);
...
"use strict";
module.exports = JSON.parse("{\"_args\":[[\"axios@0.21.1\",\"/workspaces/slack-user-sync\"]],\"_from\":\"axios@0.21.1\",\"_id\":\"axios@0.21.1\",\"_inBundle\":false,\"_integrity\":\"sha512-dKQiRHxGD9PPRIUNIWvZhPTPpl1rf/OxTYKsqKUDjBwYylTvV7SjSHJb9ratfyzM6wCdLCOYLzs73qpg5c4iGA==\",\"_location\":\"/axios\",\"_phantomChildren\":{},\"_requested\":{\"type\":\"version\",\"registry\":true,\"raw\":\"axios@0.21.1\",\"name\":\"axios\",\"escapedName\":\"axios\",\"rawSpec\":\"0.21.1\",\"saveSpec\":null,\"fetchSpec\":\"0.21.1\"},\"_requiredBy\":[\"/@slack/web-api\"],\"_resolved\":\"https://registry.npmjs.org/axios/-/axios-0.21.1.tgz\",\"_spec\":\"0.21.1\",\"_where\":\"/workspaces/slack-user-sync\",\"author\":{\"name\":\"Matt Zabriskie\"},\"browser\":{\"./lib/adapters/http.js\":\"./lib/adapters/xhr.js\"},\"bugs\":{\"url\":\"https://github.com/axios/axios/issues\"},\"bundlesize\":[{\"path\":\"./dist/axios.min.js\",\"threshold\":\"5kB\"}],\"dependencies\":{\"follow-redirects\":\"^1.10.0\"},\"description\":\"Promise based HTTP client for the browser and node.js\",\"devDependencies\":{\"bundlesize\":\"^0.17.0\",\"coveralls\":\"^3.0.0\",\"es6-promise\":\"^4.2.4\",\"grunt\":\"^1.0.2\",\"grunt-banner\":\"^0.6.0\",\"grunt-cli\":\"^1.2.0\",\"grunt-contrib-clean\":\"^1.1.0\",\"grunt-contrib-watch\":\"^1.0.0\",\"grunt-eslint\":\"^20.1.0\",\"grunt-karma\":\"^2.0.0\",\"grunt-mocha-test\":\"^0.13.3\",\"grunt-ts\":\"^6.0.0-beta.19\",\"grunt-webpack\":\"^1.0.18\",\"istanbul-instrumenter-loader\":\"^1.0.0\",\"jasmine-core\":\"^2.4.1\",\"karma\":\"^1.3.0\",\"karma-chrome-launcher\":\"^2.2.0\",\"karma-coverage\":\"^1.1.1\",\"karma-firefox-launcher\":\"^1.1.0\",\"karma-jasmine\":\"^1.1.1\",\"karma-jasmine-ajax\":\"^0.1.13\",\"karma-opera-launcher\":\"^1.0.0\",\"karma-safari-launcher\":\"^1.0.0\",\"karma-sauce-launcher\":\"^1.2.0\",\"karma-sinon\":\"^1.0.5\",\"karma-sourcemap-loader\":\"^0.3.7\",\"karma-webpack\":\"^1.7.0\",\"load-grunt-tasks\":\"^3.5.2\",\"minimist\":\"^1.2.0\",\"mocha\":\"^5.2.0\",\"sinon\":\"^4.5.0\",\"typescript\":\"^2.8.1\",\"url-search-params\":\"^0.10.0\",\"webpack\":\"^1.13.1\",\"webpack-dev-server\":\"^1.14.1\"},\"homepage\":\"https://github.com/axios/axios\",\"jsdelivr\":\"dist/axios.min.js\",\"keywords\":[\"xhr\",\"http\",\"ajax\",\"promise\",\"node\"],\"license\":\"MIT\",\"main\":\"index.js\",\"name\":\"axios\",\"repository\":{\"type\":\"git\",\"url\":\"git+https://github.com/axios/axios.git\"},\"scripts\":{\"build\":\"NODE_ENV=production grunt build\",\"coveralls\":\"cat coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js\",\"examples\":\"node ./examples/server.js\",\"fix\":\"eslint --fix lib/**/*.js\",\"postversion\":\"git push && git push --tags\",\"preversion\":\"npm test\",\"start\":\"node ./sandbox/server.js\",\"test\":\"grunt test && bundlesize\",\"version\":\"npm run build && grunt version && git add -A dist && git add CHANGELOG.md bower.json package.json\"},\"typings\":\"./index.d.ts\",\"unpkg\":\"dist/axios.min.js\",\"version\":\"0.21.1\"}");
...
/******/ 	return __nccwpck_require__(6968);
/******/ })()
;